...
public class EmpInten4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_icon1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpInten4Activity.this, EmpHome1Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        menu_icon2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpInten4Activity.this, EmpExtra1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpInten4Activity.this, EmpWPH1Activity.class);
                startActivity(intent);
            }
        });
