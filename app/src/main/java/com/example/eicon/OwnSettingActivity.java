...
//이소리(leesori1410)
public class OwnSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_icon1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OwnSettingActivity.this, OwnHome1Activity.class);
        ...
        menu_icon2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OwnSettingActivity.this, OwnExtra1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OwnSettingActivity.this, OwnHTE1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OwnSettingActivity.this, OwnSettingActivity.class);
                startActivity(intent);
            }
        });
