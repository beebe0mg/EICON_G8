...
//이소리(leesori1410)
public class EmpOccu3Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_emp_occu3);
        ...
        empoccu3activity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EmpOccu3Activity.this, EmpOccu4Activity.class);
        ...
        menu_icon1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpOccu3Activity.this, EmpHome1Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        menu_icon2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpOccu3Activity.this, EmpExtra1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpOccu3Activity.this, EmpWPH1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpOccu3Activity.this, EmpSettingActivity.class);
                startActivity(intent);
            }
        });
    }
