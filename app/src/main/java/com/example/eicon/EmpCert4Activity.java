...
public class EmpCert4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_emp_cert4);
        ...
        ImageView empcert4activity = findViewById(R.id.empcert4activity);
        empcert4activity.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        menu_icon2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpCert4Activity.this, EmpExtra1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpCert4Activity.this, EmpWPH1Activity.class);
                startActivity(intent);
            }
        });
