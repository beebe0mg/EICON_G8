...
//이소리(leesori1410)
public class EmpTrain2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_emp_train2);
        ...
        emptrain2activity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EmpTrain2Activity.this, EmpTrain3Activity.class);
        ...
        menu_icon1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpTrain2Activity.this, EmpHome1Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        menu_icon2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpTrain2Activity.this, EmpExtra1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpTrain2Activity.this, EmpWPH1Activity.class);
                startActivity(intent);
            }
        });
        ...
        menu_icon4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EmpTrain2Activity.this, EmpSettingActivity.class);
                startActivity(intent);
            }
        });
    }
